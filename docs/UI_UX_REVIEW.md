...
合成封面的浏览器验证覆盖两种主题的 1024×640、1440×810、1920×1080、1440×1000：首页与详情的实际图片宽高、坐标一致，没有横向溢出，操作按钮和唯一遥控焦点正常。simpleUI 进入剧集列表后仍卸载 Hero 封面，回到 Hero 后恢复；液态玻璃保留列表的全局封面背景。本次真机回归未执行。
